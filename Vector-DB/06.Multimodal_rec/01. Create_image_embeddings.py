...
if __name__ == "__main__":
    ...
    # 기존에 데이터가 있었다면, 삭제
    open('../data/imaterialist-fashion-2020-fgvc7/img_embeddings_fashion_fine_tuned.json', 'w').close()
    ...
    for i in tqdm(images):
        ...
        with open('../data/imaterialist-fashion-2020-fgvc7/img_embeddings_fashion_fine_tuned.json','a') as file:
            key = i.split(".")[0]
